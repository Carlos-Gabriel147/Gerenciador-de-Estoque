...
<body>
	<div class="fundo">
		<a href="estoque_geral.php"><div class="seta-esquerda2"></div></a>
		<div class="areamenu">
			<a href="index.php" class="menu">Menu Principal</a>
		</div>
		<div class="fundo-branco">
			<div class="titulo">
				<h2 class="titulo">Estoque Baixo</h2> 
			</div>
			<div class="pesquisas">
				<div class="campo">
			...
			<p class="espaco"></p>
			<div class="opcoes">
				<a href="estoque_baixo.php"><img src="imagens/icone_atualizar.png" class="opcao"></a>
			...
			<div class="dados">
				<?php
					$tabela = mysqli_query($con, "SELECT * FROM estoque WHERE Quantidade <= Baixo ORDER BY Categoria, Nome");
					function buscar($conexao,$busca){
						if($_POST['palavra'] != ""){
							...
							$sql = mysqli_query($conexao, "SELECT * FROM estoque WHERE ".$busca." LIKE ".$palavra." AND Quantidade <= Baixo");						
				...
				<table cellpadding="0" cellspacing="0" border="1" class="sortable" bordercolor=#818181>
					...
					<?php 
						while($tab = mysqli_fetch_object($tabela)){
							echo "<tr class='baixo' rowspan='2'><td>".$tab->Codigo."</td><td>".$tab->Nome."</td><td>".$tab->Categoria."</td><td>".$tab->Quantidade."</td></tr>";
						}
					?>
				</table>
			</div>
